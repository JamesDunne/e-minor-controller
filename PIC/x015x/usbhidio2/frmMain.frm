...
'You must set MyVendorID and MyProductID to match the values of your HID.

'For companion device firmware and PC applications for Visual Basic .NET and Visual C++,
'see my HID page at www.Lvr.com/hidpage.htm.
...
Dim Needed As Long
Dim OutputReportData(128) As Byte
...
Const MyVendorID = &H9AE
Const MyProductID = &H4430
